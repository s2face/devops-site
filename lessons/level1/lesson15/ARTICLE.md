...
1.  [ ] Я могу объяснить разницу между Continuous Delivery и Continuous Deployment.
2.  [ ] Я понимаю, почему YAML-файлы чувствительны к отступам.
3.  [ ] В моем репозитории нет «захардкоженных» паролей.
4.  [ ] Мой пайплайн не собирает Docker-образ, если тесты упали.
5.  [ ] Я знаю, где в интерфейсе GitHub посмотреть логи упавшей джобы.
